...
/**
 * @see TestDoctrineReadFactoryFactorySpec
 * @see TestDoctrineReadFactoryFactoryTest
 */
class TestDoctrineReadFactoryFactory
{
    /**
     * @var array
     */
    ...
    public function createFromDoctrineReadFactory(DoctrineReadFactory $definition): TestDoctrineReadFactory
    {
        $methods = [];
        ...
        return new TestDoctrineReadFactory($testClassName, $testParentName, [], [], [], $properties, $methods, $definition->getInstanceOf());
    }
}
