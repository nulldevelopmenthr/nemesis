...
/**
 * @see TheaterNamingStrategySpec
 * @see TheaterNamingStrategyTest
 */
class TheaterNamingStrategy implements NamingStrategy
{
    /** @var ContextName */
    private $contextName;
    ...
    {
        $namespace = $this->getDomainNamespace().'\Command';
    ...
    {
        $namespace = $this->getDomainNamespace().'\Event';
