...
class BroadwayDoctrineOrmReadCliCommand extends BaseSkeletonGeneratorCommand
{
    ...
    protected function getSources(CreateBroadwayDoctrineOrmRead $command): array
    {
        return $this->getService(CreateBroadwayDoctrineOrmReadHandler::class)->handle($command);
    }
