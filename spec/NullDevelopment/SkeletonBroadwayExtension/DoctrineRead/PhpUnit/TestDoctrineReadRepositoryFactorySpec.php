...
class TestDoctrineReadRepositoryFactorySpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(TestDoctrineReadRepositoryFactory::class);
    }
    ...
    public function it_will_create_specification_for_single_value_object(
        ...
        $result->shouldReturnAnInstanceOf(TestDoctrineReadRepository::class);
