...
class DoctrineReadRepositoryLoaderSpec extends ObjectBehavior
{
    public function let(
    ...
    {
        $this->shouldHaveType(DoctrineReadRepositoryLoader::class);
        $this->shouldImplement(DefinitionLoader::class);
    }

    public function it_supports_configs_defined_as_single_value_objects()
    {
        $this->supports(['type' => 'DoctrineReadRepository'])->shouldReturn(true);
    }
}
