...
class DoctrineReadProjectorLoaderSpec extends ObjectBehavior
{
    public function let(
    ...
    {
        $this->shouldHaveType(DoctrineReadProjectorLoader::class);
        $this->shouldImplement(DefinitionLoader::class);
    }

    public function it_supports_configs_defined_as_single_value_objects()
    {
        $this->supports(['type' => 'DoctrineReadProjector'])->shouldReturn(true);
    }
}
