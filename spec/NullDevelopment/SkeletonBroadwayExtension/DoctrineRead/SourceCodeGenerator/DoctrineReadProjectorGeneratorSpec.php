...
class DoctrineReadProjectorGeneratorSpec extends ObjectBehavior
{
    public function let(
    ...
    {
        $this->shouldHaveType(DoctrineReadProjectorGenerator::class);
        $this->shouldImplement(DefinitionGenerator::class);
    }

    public function it_supports_single_value_object(DoctrineReadProjector $definition)
    {
        $this->supports($definition)->shouldReturn(true);
    }

    public function it_creates_class_code(DoctrineReadProjector $definition)
    {
    ...
    public function it_creates_class_code_with_parent(DoctrineReadProjector $definition)
    {
        $definition->getInstanceOfName()->shouldBeCalled()->willReturn('UserEntity');
        $definition->getNamespace()->shouldBeCalled()->willReturn('MyVendor\\WebShop');
        $definition->getInstanceOfFullName()->shouldBeCalled()->willReturn('MyVendor\\WebShop\\UserEntity');
    ...
    public function it_creates_class_code_with_interfaces(DoctrineReadProjector $definition, InterfaceName $interfaceName)
    {
        $definition->getInstanceOfName()->shouldBeCalled()->willReturn('UserEntity');
        $definition->getNamespace()->shouldBeCalled()->willReturn('MyVendor\\WebShop');
        $definition->getInstanceOfFullName()->shouldBeCalled()->willReturn('MyVendor\\WebShop\\UserEntity');
    ...
    public function it_creates_class_code_with_properties(DoctrineReadProjector $definition, Property $firstName)
    {
        $definition->getInstanceOfName()->shouldBeCalled()->willReturn('UserEntity');
        $definition->getNamespace()->shouldBeCalled()->willReturn('MyVendor\\WebShop');
        $definition->getInstanceOfFullName()->shouldBeCalled()->willReturn('MyVendor\\WebShop\\UserEntity');
