...
class DoctrineReadRepositoryGeneratorSpec extends ObjectBehavior
{
    public function let(
    ...
    {
        $this->shouldHaveType(DoctrineReadRepositoryGenerator::class);
        $this->shouldImplement(DefinitionGenerator::class);
    }

    public function it_supports_single_value_object(DoctrineReadRepository $definition)
    {
        $this->supports($definition)->shouldReturn(true);
    }

    public function it_creates_class_code(DoctrineReadRepository $definition)
    {
    ...
    public function it_creates_class_code_with_parent(DoctrineReadRepository $definition)
    {
        $definition->getInstanceOfName()->shouldBeCalled()->willReturn('UserEntity');
        $definition->getNamespace()->shouldBeCalled()->willReturn('MyVendor\\WebShop');
        $definition->getInstanceOfFullName()->shouldBeCalled()->willReturn('MyVendor\\WebShop\\UserEntity');
    ...
    public function it_creates_class_code_with_interfaces(DoctrineReadRepository $definition, InterfaceName $interfaceName)
    {
        $definition->getInstanceOfName()->shouldBeCalled()->willReturn('UserEntity');
        $definition->getNamespace()->shouldBeCalled()->willReturn('MyVendor\\WebShop');
        $definition->getInstanceOfFullName()->shouldBeCalled()->willReturn('MyVendor\\WebShop\\UserEntity');
    ...
    public function it_creates_class_code_with_properties(DoctrineReadRepository $definition, Property $firstName)
    {
        $definition->getInstanceOfName()->shouldBeCalled()->willReturn('UserEntity');
        $definition->getNamespace()->shouldBeCalled()->willReturn('MyVendor\\WebShop');
        $definition->getInstanceOfFullName()->shouldBeCalled()->willReturn('MyVendor\\WebShop\\UserEntity');
    ...
    public function it_creates_class_code_with_property_having_default_value(
        DoctrineReadRepository $definition,
        Property $lastName
    ) {
        $definition->getInstanceOfName()->shouldBeCalled()->willReturn('UserEntity');
        $definition->getNamespace()->shouldBeCalled()->willReturn('MyVendor\\WebShop');
