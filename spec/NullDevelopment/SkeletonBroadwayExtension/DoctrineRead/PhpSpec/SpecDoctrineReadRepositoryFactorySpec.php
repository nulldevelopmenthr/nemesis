...
class SpecDoctrineReadRepositoryFactorySpec extends ObjectBehavior
{
    public function let(
    ...
    {
        $this->shouldHaveType(SpecDoctrineReadRepositoryFactory::class);
    }
    ...
    public function it_will_create_specification_for_single_value_object(
        ...
        $result = $this->createFromDoctrineReadRepository($definition);
        $result->shouldReturnAnInstanceOf(SpecDoctrineReadRepository::class);
