...
namespace spec\NullDevelopment\SkeletonSourceCodeExtension\Definition;
...
class UuidV4IdentifierSpec extends ObjectBehavior
{
    public function let(
        ClassName $name,
        ClassName $parent,
    ...
    {
        $this->shouldHaveType(UuidV4Identifier::class);
