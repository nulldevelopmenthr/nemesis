 ...
 * @group  todo
 */
class ImprovedTestSourceTest extends PHPUnit_Framework_TestCase
{
    use MockeryPHPUnitIntegration;
    /** @var \Mockery\MockInterface|ClassType */
    private $classType;
    /** @var ImprovedTestSource */
    private $improvedTestSource;

    public function setUp()
    {
        $this->classType          = Mockery::mock(ClassType::class);
        $this->improvedTestSource = new ImprovedTestSource($this->classType);
    }
