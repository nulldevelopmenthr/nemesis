...
/**
 * @covers \NullDev\Skeleton\Source\ImprovedSpecSource
 * @group  todo
 */
class ImprovedSpecSourceTest extends PHPUnit_Framework_TestCase
{
    use MockeryPHPUnitIntegration;
    /** @var \Mockery\MockInterface|ClassType */
    private $classType;
    /** @var ImprovedSpecSource */
    private $improvedSpecSource;

    public function setUp()
    {
        $this->classType          = Mockery::mock(ClassType::class);
        $this->improvedSpecSource = new ImprovedSpecSource($this->classType);
    }
