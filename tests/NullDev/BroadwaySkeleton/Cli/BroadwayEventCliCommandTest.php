...
use NullDev\BroadwaySkeleton\Cli\BroadwayEventCliCommand;
use PHPUnit_Framework_TestCase;

/**
 * @covers \NullDev\BroadwaySkeleton\Cli\BroadwayEventCliCommand
 * @group  todo
 */
class BroadwayEventCliCommandTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->name                    = 'name';
        $this->broadwayEventCliCommand = new BroadwayEventCliCommand($this->name);
    }
