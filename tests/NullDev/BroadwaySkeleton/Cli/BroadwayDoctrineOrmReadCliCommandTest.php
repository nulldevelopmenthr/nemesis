...
use NullDev\BroadwaySkeleton\Cli\BroadwayDoctrineOrmReadCliCommand;
use PHPUnit_Framework_TestCase;

/**
 * @covers \NullDev\BroadwaySkeleton\Cli\BroadwayDoctrineOrmReadCliCommand
 * @group  todo
 */
class BroadwayDoctrineOrmReadCliCommandTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->name                              = 'name';
        $this->broadwayDoctrineOrmReadCliCommand = new BroadwayDoctrineOrmReadCliCommand($this->name);
    }
