...
use NullDev\BroadwaySkeleton\Cli\BroadwayCommandCliCommand;
use PHPUnit_Framework_TestCase;

/**
 * @covers \NullDev\BroadwaySkeleton\Cli\BroadwayCommandCliCommand
 * @group  todo
 */
class BroadwayCommandCliCommandTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->name                      = 'name';
        $this->broadwayCommandCliCommand = new BroadwayCommandCliCommand($this->name);
    }
