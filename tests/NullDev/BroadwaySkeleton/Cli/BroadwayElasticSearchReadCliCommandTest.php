...
namespace tests\NullDev\BroadwaySkeleton\Cli;

use Mockery\Adapter\Phpunit\MockeryPHPUnitIntegration;
use NullDev\BroadwaySkeleton\Cli\BroadwayElasticSearchReadCliCommand;
use PHPUnit_Framework_TestCase;

/**
 * @covers \NullDev\BroadwaySkeleton\Cli\BroadwayElasticSearchReadCliCommand
 * @group  todo
 */
class BroadwayElasticSearchReadCliCommandTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->name                                = 'name';
        $this->broadwayElasticSearchReadCliCommand = new BroadwayElasticSearchReadCliCommand($this->name);
    }
