...
use NullDev\BroadwaySkeleton\Cli\BroadwayModelCliCommand;
use PHPUnit_Framework_TestCase;

/**
 * @covers \NullDev\BroadwaySkeleton\Cli\BroadwayModelCliCommand
 * @group  todo
 */
class BroadwayModelCliCommandTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->name                    = 'name';
        $this->broadwayModelCliCommand = new BroadwayModelCliCommand($this->name);
    }
