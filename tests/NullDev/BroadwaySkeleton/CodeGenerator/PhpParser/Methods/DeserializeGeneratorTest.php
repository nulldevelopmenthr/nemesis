 ...
 * @group  nemesis
 */
class DeserializeGeneratorTest extends BaseOutputGeneratorTestCase
{
    public function getGenerator(): DeserializeGenerator
    {
        return new DeserializeGenerator(new BuilderFactory());
    }
