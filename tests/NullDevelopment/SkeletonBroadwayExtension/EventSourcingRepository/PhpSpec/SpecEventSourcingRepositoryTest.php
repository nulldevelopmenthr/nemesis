...
/**
 * @covers \NullDevelopment\SkeletonBroadwayExtension\EventSourcingRepository\PhpSpec\SpecEventSourcingRepository
 * @group  todo
 */
class SpecEventSourcingRepositoryTest extends TestCase
{
    ...
    /** @var SpecEventSourcingRepository */
    private $sut;
    ...
    public function setUp()
    {
        ...
        $this->sut = new SpecEventSourcingRepository(
            $this->name,
            $this->parent,
            $this->interfaces,
            $this->traits,
