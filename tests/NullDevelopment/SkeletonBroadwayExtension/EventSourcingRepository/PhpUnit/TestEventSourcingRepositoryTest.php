...
/**
 * @covers \NullDevelopment\SkeletonBroadwayExtension\EventSourcingRepository\PhpUnit\TestEventSourcingRepository
 * @group  todo
 */
class TestEventSourcingRepositoryTest extends TestCase
{
    ...
    /** @var TestEventSourcingRepository */
    private $sut;
    ...
    public function setUp()
    {
        ...
        $this->sut               = new TestEventSourcingRepository(
            $this->name,
            $this->parent,
            $this->interfaces,
            $this->traits,
