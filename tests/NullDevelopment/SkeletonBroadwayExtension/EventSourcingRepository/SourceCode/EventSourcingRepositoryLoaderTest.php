...
/**
 * @covers \NullDevelopment\SkeletonBroadwayExtension\EventSourcingRepository\SourceCode\EventSourcingRepositoryLoader
 * @group  todo
 */
class EventSourcingRepositoryLoaderTest extends TestCase
{
    ...
    /** @var EventSourcingRepositoryLoader */
    private $sut;
    ...
    public function setUp()
    {
        ...
        $this->sut                            = new EventSourcingRepositoryLoader(
