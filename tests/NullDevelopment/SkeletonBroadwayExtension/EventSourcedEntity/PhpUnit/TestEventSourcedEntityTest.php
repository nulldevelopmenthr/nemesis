...
/**
 * @covers \NullDevelopment\SkeletonBroadwayExtension\EventSourcedEntity\PhpUnit\TestEventSourcedEntity
 * @group  todo
 */
class TestEventSourcedEntityTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->sut               = new TestEventSourcedEntity(
            $this->name,
            $this->parent,
            $this->interfaces,
            $this->traits,
