...
/**
 * @covers \NullDevelopment\SkeletonBroadwayExtension\EventSourcedEntity\PhpSpec\SpecEventSourcedEntity
 * @group  todo
 */
class SpecEventSourcedEntityTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->sut = new SpecEventSourcedEntity(
            $this->name,
            $this->parent,
            $this->interfaces,
            $this->traits,
