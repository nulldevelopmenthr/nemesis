...
/**
 * @covers \NullDevelopment\SkeletonBroadwayExtension\EventSourcedAggregateRoot\PhpSpec\SpecEventSourcedAggregateRoot
 * @group  todo
 */
class SpecEventSourcedAggregateRootTest extends TestCase
{
    ...
    /** @var SpecEventSourcedAggregateRoot */
    private $sut;
    ...
    public function setUp()
    {
        ...
        $this->sut = new SpecEventSourcedAggregateRoot(
            $this->name,
            $this->parent,
            $this->interfaces,
            $this->traits,
