...
/**
 * @covers \NullDevelopment\SkeletonBroadwayExtension\CommandHandler\PhpSpec\SpecCommandHandler
 * @group  todo
 */
class SpecCommandHandlerTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->sut = new SpecCommandHandler(
            $this->name,
            $this->parent,
            $this->interfaces,
            $this->traits,
