...
/**
 * @covers \NullDevelopment\SkeletonBroadwayExtension\DoctrineRead\PhpSpec\SpecDoctrineReadRepository
 * @group  unit
 */
class SpecDoctrineReadRepositoryTest extends TestCase
{
    ...
    /** @var SpecDoctrineReadRepository */
    private $sut;
    ...
    public function setUp()
    {
        ...
        $this->sut = new SpecDoctrineReadRepository(
            $this->name,
            $this->parent,
            $this->interfaces,
            $this->traits,
