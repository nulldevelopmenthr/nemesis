...
/**
 * @covers \NullDevelopment\SkeletonBroadwayExtension\DoctrineRead\PhpSpec\SpecDoctrineReadFactory
 * @group  unit
 */
class SpecDoctrineReadFactoryTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->sut = new SpecDoctrineReadFactory(
            $this->name,
            $this->parent,
            $this->interfaces,
            $this->traits,
