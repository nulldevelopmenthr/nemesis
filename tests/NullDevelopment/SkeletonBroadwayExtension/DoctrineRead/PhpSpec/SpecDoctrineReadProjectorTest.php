...
/**
 * @covers \NullDevelopment\SkeletonBroadwayExtension\DoctrineRead\PhpSpec\SpecDoctrineReadProjector
 * @group  unit
 */
class SpecDoctrineReadProjectorTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->sut = new SpecDoctrineReadProjector(
            $this->name,
            $this->parent,
            $this->interfaces,
            $this->traits,
