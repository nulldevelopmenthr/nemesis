...
/**
 * @covers \NullDevelopment\SkeletonBroadwayExtension\DoctrineRead\SourceCode\DoctrineReadRepository
 * @group  unit
 */
class DoctrineReadRepositoryTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->sut               = new DoctrineReadRepository(
            $this->name,
            $this->parent,
            $this->interfaces,
            $this->traits,
