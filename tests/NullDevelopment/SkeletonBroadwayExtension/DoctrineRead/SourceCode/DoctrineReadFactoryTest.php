...
/**
 * @covers \NullDevelopment\SkeletonBroadwayExtension\DoctrineRead\SourceCode\DoctrineReadFactory
 * @group  unit
 */
class DoctrineReadFactoryTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->sut               = new DoctrineReadFactory(
            $this->name,
            $this->parent,
            $this->interfaces,
            $this->traits,
