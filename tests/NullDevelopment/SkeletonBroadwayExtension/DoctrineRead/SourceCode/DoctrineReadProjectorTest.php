...
/**
 * @covers \NullDevelopment\SkeletonBroadwayExtension\DoctrineRead\SourceCode\DoctrineReadProjector
 * @group  unit
 */
class DoctrineReadProjectorTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->sut               = new DoctrineReadProjector(
            $this->name,
            $this->parent,
            $this->interfaces,
            $this->traits,
