...
/**
 * @covers \NullDevelopment\SkeletonBroadwayExtension\DoctrineRead\SourceCode\DoctrineReadEntity
 * @group  unit
 */
class DoctrineReadEntityTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->sut               = new DoctrineReadEntity(
            $this->name,
            $this->parent,
            $this->interfaces,
            $this->traits,
