...
/**
 * @covers \NullDevelopment\SkeletonBroadwayExtension\DoctrineRead\PhpUnit\TestDoctrineReadFactory
 * @group  todo
 */
class TestDoctrineReadFactoryTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->sut               = new TestDoctrineReadFactory(
            $this->name,
            $this->parent,
            $this->interfaces,
            $this->traits,
