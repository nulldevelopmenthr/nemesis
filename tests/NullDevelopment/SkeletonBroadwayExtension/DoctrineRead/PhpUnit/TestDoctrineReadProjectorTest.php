...
/**
 * @covers \NullDevelopment\SkeletonBroadwayExtension\DoctrineRead\PhpUnit\TestDoctrineReadProjector
 * @group  todo
 */
class TestDoctrineReadProjectorTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->sut               = new TestDoctrineReadProjector(
            $this->name,
            $this->parent,
            $this->interfaces,
            $this->traits,
