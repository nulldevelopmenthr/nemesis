...
/**
 * @covers \NullDevelopment\SkeletonBroadwayExtension\DoctrineRead\PhpUnit\TestDoctrineReadRepository
 * @group  todo
 */
class TestDoctrineReadRepositoryTest extends TestCase
{
    ...
    /** @var TestDoctrineReadRepository */
    private $sut;
    ...
    public function setUp()
    {
        ...
        $this->sut               = new TestDoctrineReadRepository(
            $this->name,
            $this->parent,
            $this->interfaces,
            $this->traits,
