...
/**
 * @covers \NullDevelopment\SkeletonBroadwayExtension\DoctrineRead\PhpUnit\TestDoctrineReadEntity
 * @group  todo
 */
class TestDoctrineReadEntityTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->sut               = new TestDoctrineReadEntity(
            $this->name,
            $this->parent,
            $this->interfaces,
            $this->traits,
