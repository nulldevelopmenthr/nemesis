...
namespace Tests\NullDevelopment\SkeletonPhpSpecExtension\Definition;
...
/**
 * @covers \NullDevelopment\SkeletonPhpSpecExtension\Definition\SpecUuidV4Identifier
 * @group  unit
 */
class SpecUuidV4IdentifierTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->sut = new SpecUuidV4Identifier(
            $this->name,
            $this->parent,
            $this->interfaces,
            $this->traits,
