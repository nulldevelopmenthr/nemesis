...
/**
 * @covers \NullDevelopment\SkeletonPhpUnitExtension\Definition\TestDateTimeValueObject
 * @group  todo
 */
class TestDateTimeValueObjectTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->sut               = new TestDateTimeValueObject(
            $this->name,
            $this->parent,
            $this->interfaces,
            $this->traits,
