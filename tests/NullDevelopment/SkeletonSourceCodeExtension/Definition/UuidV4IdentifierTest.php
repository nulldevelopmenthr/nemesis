...
namespace Tests\NullDevelopment\SkeletonSourceCodeExtension\Definition;
...
/**
 * @covers \NullDevelopment\SkeletonSourceCodeExtension\Definition\UuidV4Identifier
 * @group  unit
 */
class UuidV4IdentifierTest extends TestCase
{
